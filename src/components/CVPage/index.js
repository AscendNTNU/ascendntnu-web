      ...
      <div className="page page-cv">
        ...
        <Section titleText="CV database">
          {this.state.public && <div>
            <input defaultValue={this.props.params.key} onInput={this.updateKeyHandler.bind(this)} placeholder="Key for profiles" />
            {this.state.key && <Link to={'/cv/' + this.state.key} className="button active">Access profiles</Link>}
          </div>}
