        ...
        <Section titleText="About Us">
          <SubSection titleText="Ascend NTNU - one of Norways most innovative student projects!">
            <p>
              ...
              <a href="http://www.ntnu.edu/">NTNU</a>. We are working towards
            ...
            <p>
              Our group was founded during the spring of 2015. In 2016 we
              competed and became third in IARC. We are now, again, preparing
          ...
          <SubSection titleText="Our team and mission">
            <p>
              ...
              studying electronics, computer science, IT, mechanics and
            ...
            <ul>
              ...
              <li>
                Navigation in a sterile environment with no external navigation
                aids such as GPS or SLAM.
              </li>
              <li>
                Interaction between competing autonomous air vehicles (mission
                7b).
              </li>
            </ul>
            <iframe
              title="Mission"
              src="https://player.vimeo.com/video/103487384"
              className="about-mission-video"
              allowFullScreen
            />
            <p>
              <i className="small">
                "The International Aerial Robotics Competition is the longest
                running collegiate aerial robotics challenge in the world.
                Entering the third decade of advancing the state of the art in
                autonomous aerial robotic behavior, the competition continues to
                tackle challenges that are currently impossible for any flying
                robots owned by government or industry."
              </i>{' '}
              -{' '}
              <a href="http://www.aerialroboticscompetition.org/">
