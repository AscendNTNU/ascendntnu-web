...
export class JoinPage extends Component {
  ...
  render () {
    ...
    let positions = {
      ...
      <Section titleText='Positions we offer offer'
        key='2' >
          <hr></hr>
    ...
    let contents = {
      ...
      <Section titleText='Reach new heights - Join Ascend NTNU'
        ...
        <p style={{
          fontSize: '1.4em'
        }} > <center><b> Application for team 2021 will start soon,<br></br> stay tuned on our social media for more information</b></center></p>
        <center><p > 
