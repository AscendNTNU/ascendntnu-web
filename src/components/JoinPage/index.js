  ...
  render () {
    ...
    let positions = {
      ...
      <Section titleText='Stillinger'
        ...
        <SubSection titleText="Event manager" id="event-manager">
          <p>
          Vi ser etter deg som digger sosiale sammenkomster! Som Event Manager vil du få muligheten til å arrangere arrangementer som ikke bare når ut til alle studentene på NTNU, men i tillegg både til presse og næringsliv i hele Norge. Du får ansvaret for å arrangere stands og fremføringer på ulike arrangementer, både internt på NTNU og utad mot næringslivet. I tillegg vil du få muligheten til å arrangere arrangementer i regi av Ascend, som for eksempel vår egen Robotikk-dag, live-demonstrasjon av droneflyvning eller avduking av våre nye droner. Hele markedsføringsgruppen kommer til å samarbeide på flere ulike nivåer, og som Event Manager vil du særlig samarbeide tett med vår sponsorkontakt for å promotere Ascends «image» til potensielle nye medlemmer og sponsorer. Dessuten får du være med på å planlegge den årlige turen vår til USA!
          <i className='key-words'> Nøkkelord: 
