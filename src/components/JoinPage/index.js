...
export class JoinPage extends Component {
  ...
  render() {
    let positions = {
      ...
      'no': [ <
        ...
        Kretskortdesign, Styrkeberegning, Materialvalg, Aerodynamikk < /i> < /
        p > <
        ...
        Kunstig Intelligens programmering, filtrering, Kalmanfilter, Sensorikk. < /i> < /
        p > <
        ...
        Deep Learning, Kunstig Intelligens programmering, Sensorikk. < /i> < /
        p > <
        ...
        Deep Learning, Reinforcement Learning, Algoritmer og Datastrukturer, Statistikk. < /i> < /
        p > <
        ...
        github hooks, server managment < /i> < /
        p > <
        /SubSection>,
        ...
        p > Prosjektleder og nestleder jobber tett sammen og fordeler arbeidsoppgaver mellom seg. 
        ...
        li > Du som er utadvent og komfortabel med å være en synlig skikkelse i Ascend både innad 
        og utad. < /li> < /
        ul > <
        p > Har du spørsmål knyttet til disse stillingene kan du kontakte Kevin Kaldvansvik 
        på < a href = {
        ...
        hjelpe resten av teamet å oppnå sitt fulle potensial. < /p> <
        p > Din oppgave vil hovedsaklig bestå av å forsikre at styret har oversiktlig regnskap, kontobalanse og 
        ...
        gruppe og ha god kontakt med andre tekniske gruppeledere. < /p> <
        i className = 'key-words' > Stikkord: Datasyn, Visuell databehandling, Deep Learning,
         Kunstig Intelligens programmering, filtrering, Kalmanfilter, Sensorikk, Visuell odometri < /i> <
        ...
        for det. < /p> <
        i className = 'key-words' > Stikkord: CAD, 3 D - print, Styrke og CFD analyser, Krets 
        design, droneflyving, dronebygging og produsering av diverse komponenter. < /i> <
        ...
        hva de andre gruppene i Ascend NTNU jobber med. < /p> <
        i className = 'key-words' > Stikkord: Kunstig Intelligens Programmering, Maskinlæring, 
        Deep Learning, Reinforcement Learning, Algoritmer og Datastrukturer, Statistikk. < /i> <
    ...
    let contents = {
      ...
      'no': [ <
          ...
          p > Ønsker du å være med på å drive med cutting-edge droneteknologi i en ambisiøs
           og teknologifokusert studentorganisasjon? < /p> <
          ...
          for å lære. < /p> 
          <p>Om du ønsker mer informasjon om hva stillingene går ut på, kom på infomøte onsdag 11 april klokken 14:30 i S2</p>
      ...
      li > < strong > Prosjekt / organisasjons - erfaring. < /strong> I Ascend er du med på 
      ...
      <
      p > Ønsker du å være med på å drive med cutting-edge droneteknologi i en ambisiøs 
      og teknologi - fokusert studentorganisasjon ? < /p> <
      p > Tidligere erfaring er ikke et krav
      for å bli med i Ascend. Det viktigste er å ha en interesse
      ...
      p > < strong > Ny mulighet vil annonseres til våren og høsten neste år. Hvis du vil bli 
      ...
      prosjekt/master - oppgave relatert til Ascend. I tillegg finnes det en åpning
      for å drive med Ascend i Eksperter i Team. < /li> <
      li > < strong > Prosjekt / organisasjons - erfaring. < /strong> I Ascend er 
  ...
  let about = {
    ...
    'no': ( <
      ...
      trenge og en egen intern kiosk. På den måten blir veien fra utvikling til testing kort. < /p> < /
      SubSection > <
