...
export class JoinPage extends Component {
  ...
  render () {
    ...
    let positions = {
      ...
      <Section titleText='Positions we offer'
        key='2' >
          <hr />
        
        <center><ul className='anchor-list' >
          <li onClick={
        ...
        } > <a > Artificial Intelligence </a></li >
          <li onClick={
          () => this.setAnchor('sponsorcontact')
        } > <a > Sponsor contacter </a></li >
          <li onClick={
        ...
        <SubSection titleText="Graphical designer" id="graphical-designer">
        <hr />
          <p>
    ...
    let contents = {
      ...
      <Section titleText='Reach new heights - Join Ascend NTNU'
        ...
        <h4><a href='https://docs.google.com/forms/d/e/1FAIpQLSdgvQ1jVRs8iJmglmyGoaWiigi1E-Q8AdNjzrBWqwz0D9ukCA/viewform' target='
          _blank ' rel='
          noopener noreferrer '>Application survey for team 2021 will come soon</a></h4> {
    ...
    let about = {
      ...
      <Section titleText='About us' >
        ...
        <SubSection titleText='How we work' >
          ...
          <ul >
            ...
            <li > 
              <strong > Confluence: </strong>We use <a href='https:/ / www.atlassian.com / software / confluence '>Confluence </a> 
      ...
      <SubSection titleText='Who we collaborate with' >
        ...
        found at the bottom on our frontpage.</p> </SubSection > <SubSection titleText='Questions?' >
