    ...
    let positions = {
      ...
      'no': [
        ...
        <SubSection titleText='Stillinger' key='2'>
          ...
          <ul className='anchor-list'>
            <li onClick={() => this.setAnchor('Prosjektleder og Nestleder')}><a>Prosjektleder og Nestleder</a></li>
            <li onClick={() => this.setAnchor('Teknisk Leder og Nestleder')}><a>Teknisk Leder og Nestleder</a></li>
            <li onClick={() => this.setAnchor('Marked og kommunikasjons leder')}><a>Markedn  og kommunikasjons leder</a></li>
            <li onClick={() => this.setAnchor('Økonomiansvarlig')}><a>Økonomiansvarlig</a></li>
            <li onClick={() => this.setAnchor('Gruppeleder i Perception')}><a>Gruppeleder i Perception</a></li>
            <li onClick={() => this.setAnchor('Gruppeleder i Control')}><a>Gruppeleder i Control</a></li>
            <li onClick={() => this.setAnchor('Gruppeleder i Hardware')}><a>Gruppeleder i Hardware</a></li>
            <li onClick={() => this.setAnchor('Gruppeleder i Artificial Intelligence (AI)')}><a>Gruppeleder i Artificial Intelligence (AI)</a></li>
          </ul>

          <SubSubSection titleText='Prosjektleder og Nestleder' id='Prosjektleder og Nestleder'>
            <p>Prosjektleder er styrets leder og jobber med å videreutvikle Ascend i ønsket retning basert på Ascends visjoner og mål. Som prosjektleder legger man i stor grad føringer for hvordan hele organisasjonen skal drives og hvordan arbeidet skal gjennomføres. Stillingen krever at man er proaktiv og ser forbedringsområder samt legger til rette for god arbeidskultur. Prosjektleder jobber tett opp mot alle Ascends undergrupper og koordinerer mye av arbeidet som skjer mellom gruppene på et overordnet plan. Sammen med marked og kommunikasjonsgruppen jobber prosjektleder for å fremme Ascends omdømme og jobbe med sponsorer. Arbeidsoppgavene man har vil variere fra uke til uke og gir muligheter til å jobbe med de fleste aspekter i prosjektet. Faste oppgaver inkluderer å lede styremøter og allmøter, og ansvar for samarbeid med hovedsponsor.</p>
          ...
          <SubSubSection titleText='Teknisk Leder og Nestleder' id='Teknisk Leder og Nestleder'>
          ...
          <SubSubSection titleText='Marked og kommunikasjons leder' id='Marked og kommunikasjons leder'>
          ...
          <SubSubSection titleText='Gruppeleder i Perception' id='Gruppeleder i Perception'>
          ...
          <SubSubSection titleText='Gruppeleder i Control' id='Gruppeleder i Control'>
          ...
          <SubSubSection titleText='Gruppeleder i Hardware' id='Gruppeleder i Hardware'>
            ...
            <i className='key-words'>Stikkord: CAD, 3D-print, Styrke og CFD analyser, Krets design, droneflyving, dronebygging og produsering av diverse komponenter.</i>
          ...
          <SubSubSection titleText='Gruppeleder i Artificial Intelligence (AI)' id='Gruppeleder i Artificial Intelligence (AI)'>
      ...
      'no': (
        <Section titleText='Om oss'>
          ...
          <SubSection titleText='Vårt tilholdssted'>
            <p>Til daglig holder vi til i Institutt for Teknisk Kybernetikk sin lab på taket av blokk A i El-bygget på Gløshaugen, kjent som taklabben. Taklabben er et arbeidslokale for alle i Ascend som har flere kraftige datamaskiner, alt utstyr du måtte trenge og en egen intern kiosk. På den måten blir veien fra utvikling til testing kort. </p>
          </SubSection>
          <SubSection titleText='Hvem vi jobber med'>
            <p>Vi har god kontakt med Institutt for Teknisk Kybernetikk (ITK), Institutt for Datateknikk og Informasjonsvitenskap (IDI) og alle våre sponsorer. Gjennom instituttene får vi tilgang til diverse labber, utstyr og kompetanse. I tillegg skriver flere av våre medlemmer prosjekt/master knyttet til Ascend for IDI og ITK. En oversikt over våre sponsorer finner du nederst på hovedsiden vår.</p>
          </SubSection>
