        ...
        <Section className="page-container-big">
          ...
          <SubSection titleText="Groups" className="page-container-big">
            {this.state.year == 2020
              ? `We currently consist of ${this.state.memberCount} students at NTNU working together to solve IARC´s mission 9 in 2021! Our team consists of seven groups: The board, AI, Control, Hardware, Marketing, Perception and ADR.`
              : ''}
            {groups}
          </SubSection>
        </Section>
