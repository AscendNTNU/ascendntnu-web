  ...
  render () {
    ...
    return (
      <div className="front-splash">
        <ModelRenderer models={['images/drones/drone2.stl']} process={Date.now()} autospin={false} wireframe={true} style={{ position: 'absolute' }} />
        ...
        <div className="front-splash-right" style={styles.rightStyle}>
          <ModelRenderer models={['images/drones/drone2.stl']} process={Date.now()} autospin={false} style={{ position: 'absolute' }} />
        </div>
      </div>
    )
  }
