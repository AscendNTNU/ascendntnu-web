        ...
        <SubSection titleText="Stillinger" key="1">
          ...
          <ul>
            <li>
                ...
                <i>Nøkkelord: Mekanisk design, Produktdesign, Elektrisk design, Kretskortdesign, Styrkeberegning, Materialvalg, Aerodynamikk</i>
            </li>
            <li>
                ...
                <i>Nøkkelord: Ledelse, Mekanisk design, Produktdesign, Elektrisk design, Kretskortdesign, Styrkeberegning, Materialvalg, Aerodynamikk.</i>
            </li>
            <li>
              <strong>Perception gruppemedlem.</strong> Perception gruppen har som oppgave å la dronen kunne oppfatte sine omgivelser og forstå hva den ser. Vi samler inn data fra en rekke sensorer og kombinerer dette for å bygge et riktig bilde av omverdenen. Som gruppemedlem i denne gruppen vil du jobbe med å skrive kunstig intelligent programvare som klarer å tyde dataen vi får fra sensorikk på dronen. Du vil bli kurset i slik teknologi om du ikke har erfaring med det fra før. <br />
              <i>Nøkkelord: Datasyn, Visuell databehandling, Deep Learning, Kunstig Intelligens programmering, Sensorikk.</i>
            </li>
            <li>
              ...
              <i>Nøkkelord: Datasyn, Visuell databehandling, Deep Learning, Kunstig Intelligens programmering, filtrering, Kalmanfilter, Sensorikk.</i>
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              <i>Nøkkelord: Design, t-skjorter, genser, jakker, visittkort, medaljer, roll-ups, flyers, postere, webdesign, magasin design, redaktør, video, motion design, 3D visualisering. </i>
            </li>
            <li>
              ...
              <i>Nøkkelord: Presentasjonteknikk, Organisert, Standutforming, Arrangementplanlegging, Organisering av stands.</i>
            </li>
            <li>
            ...
            <i>Nøkkelord: Webutvikling, full-stack (backend og frontend), grafisk design, react, typescript, app utvikling. Sysadmin, continous integration, github hooks, server managment</i>
            </li>
