  ...
  render () {
      ...
      let team_photo: any = (
        <div className="section page-container">
          ...
          <img src={"/images/teams/" + this.state.year + "/ascend-group-" + this.state.year + ".jpg"} style={ { width: "inherit", maxWidth: "100%", height: "auto !important", maxHeight: "100%" } } className="responsive-image" />
        </div>
      );
