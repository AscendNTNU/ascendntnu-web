      ...
      <div className="head">
        <div className="head-content page-container">
          ...
          <nav className="nav-bar">
            <IndexLink onClick={() => {this.props.toggleMenuHandler; this.state.hoverAbout = false}} className="nav-element" activeClassName="active" to="/">Home</IndexLink>
            <Link onClick={() => {this.props.toggleMenuHandler; this.state.hoverAbout = false}} className="nav-element" activeClassName="active" to="/blog">Blog</Link>
            <Link onClick={() => {this.props.toggleMenuHandler; this.state.hoverAbout = false}} className="nav-element" activeClassName="active" to="/drones">Drones</Link>
            <Link onClick={() => {this.props.toggleMenuHandler; this.state.hoverAbout = false}} className="nav-element" activeClassName="active" to="/join">Join Us</Link>
            <Link onClick={() => {this.props.toggleMenuHandler; this.state.hoverAbout = false}} className="nav-element" activeClassName="active" to="/team">Team</Link>
